...
class ProductPageLocators(MainPageLocators):
    ...
    BASKET_TOTAL_MESSAGE = (By.XPATH, '//div[contains(@class,"alert-info")]/div[contains(@class,"alertinner")]/p/strong')

class BasketPageLocators(object):
    BASKET_TILE_EN = (By.XPATH, '//head/title[contains(text(),"Basket")]')
    PAGE_ACTION_TITLE_EN =(By.XPATH, '//div[contains(@class,"page-header") and contains(@class,"action")]/h1[contains(text(),"Basket")]')
