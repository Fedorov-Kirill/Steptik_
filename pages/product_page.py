...
class ProductPage(BasePage):
    ...
    def should_be_product_instock(self):
        assert self.is_element_present(*ProductPageLocators.PRODUCT_INSTOCK), "Product instock availability is not found."
    ...
    def add_product_to_basket(self):
        ...
        # sercher = re.search(r'x = (?P<Number>\d+)', alert_text)
        # x = int(sercher.group("Number"))        
        # print('x=', x)
